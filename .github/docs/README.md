...
- `issue-linking.md` - Link issues with PRs
...
- `read_issues.py` - Read issues

## 🚀 Quick Links

- **[Project Status](../PROJECT_STATUS.md)** - Current phase and progress
- **[Workflows](../workflows/)** - CI/CD configurations
...
1. **[Getting Started Guide](setup/getting-started.md)** - Setup your environment
2. **[Git Flow Guide](workflow/git-flow.md)** - Understand our Git workflow
3. **[Token Setup](setup/token-setup.md)** - Configure GitHub token
...
**💡 Tip:** All documentation follows the same structure for easy navigation!
