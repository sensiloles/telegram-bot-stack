...
[![CI](https://img.shields.io/github/actions/workflow/status/sensiloles/telegram-bot-stack/ci.yml?branch=main&label=CI)](https://github.com/sensiloles/telegram-bot-stack/actions/workflows/ci.yml)
