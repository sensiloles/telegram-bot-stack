...
class UserManager:
    ...
    def __init__(self, storage: Storage, storage_key: str = "bot_users"):
        """Initialize user manager with storage.

        Args:
            storage: Storage instance for persisting user data
            storage_key: Key to use in storage for user data
        """
